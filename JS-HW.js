...
if (a > b) {
    if (a > c) {
             if (b > c){console.log('average = ', avg = b)}
             else {console.log('average = ', avg = c)}}
          else {console.log('average = ', avg = a)}
        }
    else {
    if (a < b) {
             if (a > c){console.log('average = ', avg = a)}
             else {console.log('average = ', avg = c)}}
          else {console.log('average = ', avg = b)}
    }
...
let MyWord = "Allowed";
let result = MyWord.replace(/[aeiouy]/gi, '')
console.log(result)
